...
function roseday(){
    ...
    dummy.style.background="url(/images/rose_circle.jpeg)";
    ...
    // to change image
    pic.src="/images/day1_img1.png";
    rose=setInterval(function(){
        let pic1=pic.getAttribute("src");
        
        if(pic1=="/images/day1_img3.png"){
            pic.animate([{opacity:0},{opacity:1}],{duration:1600});
            pic.src="/images/day1_img1.png";
        }
        else if (pic1=="/images/day1_img1.png"){
            pic.animate([{opacity:0},{opacity:1}],{duration:1600});
            pic.src="/images/day1_img2.jpg";
        }
        else if (pic1=="/images/day1_img2.jpg"){
            pic.animate([{opacity:0},{opacity:1}],{duration:1600});
            pic.src="/images/day1_img3.png";
...
function no_day(){
    ...
    dummy.style.background="url(/images/no_day_background.avif)";
    dummy.style.backgroundSize="100% 100%";
